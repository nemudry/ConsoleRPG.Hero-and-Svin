...
namespace SVINspace
{
    public class ThiefElf : Hero, IElfEffects, IThiefEffects
    {

        public ThiefElf(string name)
        {
        ...
        public ThiefElf(string name, int level, int rank, int hp, int mana, int exp, int defence, int attack, int crit, int money, Hero.statusHero status,
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (Level != 1)
                    {
                        ...
                        MainFeatures = (HP + 20, Mana +20, Attack + 5, Defence + 2, Crit + 2);
