...
namespace SVINspace
{
    public class MageGnom : Hero, IGnomEffects, IMageEffects
    {

        public MageGnom(string name)
        {
        ...
        public MageGnom(string name, int level, int rank, int hp, int mana, int exp, int defence, int attack, int crit, int money, Hero.statusHero status,
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (Level != 1)
                    {
                        ...
                        MainFeatures = (HP + 30, Mana + 20, Attack + 5, Defence + 2, Crit + 1);
