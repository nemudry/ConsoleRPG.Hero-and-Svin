...
namespace SVINspace
{
    public class WarriorGnom : Hero, IGnomEffects, IWarriorEffects
    {

        public WarriorGnom(string name)
        {
        ...
        public WarriorGnom(string name, int level, int rank, int hp, int mana, int exp, int defence, int attack, int crit, int money, Hero.statusHero status,
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (Level != 1)
                    {
                        ...
                        MainFeatures = (HP + 50, Mana +10, Attack + 2, Defence + 5, Crit + 0);
