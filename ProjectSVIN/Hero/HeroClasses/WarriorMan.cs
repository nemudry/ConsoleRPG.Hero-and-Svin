...
namespace SVINspace
{
    public class WarriorMan : Hero, IManEffects, IWarriorEffects
    {
        ...
        public WarriorMan(string name, int level, int rank, int hp, int mana, int exp, int defence, int attack, int crit, int money, Hero.statusHero status,
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (Level != 1)
                    {
                        ...
                        MainFeatures = (HP + 30, Mana + 15, Attack + 5, Defence + 5, Crit + 0);
